...
produceResultado("resultadoFinalNormal__1.5.json", lista_textOri_filtrada,"deepseek-r1:1.5b")



# Nombre del archivo donde se guardará el JSON
archivo_salida = "resultadoErrores__1.5.json"
...
# Nombre del archivo donde se guardará el JSON
archivo_salida = "resultadoErroresRaros__1.5.json"
