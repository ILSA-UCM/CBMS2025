...
# Round precision, recall, and F1-score to 3 decimal places
df_05[['Precision', 'Recall', 'F1-Score']] = df_05[['Precision', 'Recall', 'F1-Score']].round(3)
df_07[['Precision', 'Recall', 'F1-Score']] = df_07[['Precision', 'Recall', 'F1-Score']].round(3)
