...
entrada_equiv_gold_to_test = "entrada_gold_to_test__1.5.txt"
entrada_equiv_test_to_test = "entrada_test_to_test__1.5.txt"
entrada_equiv_gold_to_gold = "entrada_gold_to_gold__1.5.txt"
