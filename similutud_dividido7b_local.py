...
equiv_gold_to_test = "V13/salida_gold_to_test__7.json"
equiv_test_to_test = "V13/salida_test_to_test__7.json"
equiv_gold_to_gold = "V13/salida_gold_to_gold__7.json"
